(function(me){
...
	var scriptName2 = scriptName.replace("01_","");
	var targetFolder = new Folder ( $.fileName.getParent() + "/ScriptUI Panels/(" +scriptName2+ ")");
	//----------------------------------
	var preset_items = [  ];
	...
	//-------------------------------------------------------------------------
	var winObj = ( me instanceof Panel) ? me : new Window("palette", scriptName, [ 843,  422,  843+ 400,  422+ 500]  ,{resizeable:true});
	//-------------------------------------------------------------------------
