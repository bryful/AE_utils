(function(me){
	...
	function setupCylinder()
	{
		...
		var scaleZ = addFx(center_null,"ADBE Slider Control","scaleZ",false);
		scaleZ.property("ADBE Slider Control-0001").setValue(100);
		...
		var exps = "[thisComp.layer(\"" + center_null.name + "\").effect(\"scaleX\")(\"ADBE Slider Control-0001\"),thisComp.layer(\""+ center_null.name+"\").effect(\"scaleY\")(\"ADBE Slider Control-0001\"),thisComp.layer(\"" + center_null.name + "\").effect(\"scaleZ\")(\"ADBE Slider Control-0001\")];";
